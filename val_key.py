...
from utils.datasets_key import create_dataloader
...
from utils.plots import plot_images_key, output_to_target_key, plot_study_txt
from utils.torch_utils import select_device, time_sync


from utils.loss_key import ComputePlateLoss
...
def val(data,
    ...
    for batch_i, (img, targets, paths, shapes) in enumerate(tqdm(dataloader, desc=s)):
        ...
        if plots and batch_i < 9:
            ...
            Thread(target=plot_images_key, args=(img, targets, paths, f, names), daemon=True).start()
            f = save_dir / f'test_batch{batch_i}_pred.jpg'  # predictions
            Thread(target=plot_images_key, args=(img, output_to_target_key(out), paths, f, names), daemon=True).start()
...
if __name__ == '__main__':
    ...
    # /home/wqg/pyproject/git/yolo/yolov5_v6_plate_heading/runs/train/exp4/weights/best.pt
    parser.add_argument('--data', type=str, default='data/yolo_data_key.yaml', help='*.data path')
